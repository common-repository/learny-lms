...
<div class="learny-form-group">
    <label for="ly_video_url"> <?php esc_html_e('Video URL', BaseController::$text_domain); ?> <span class="learny-text-danger">*</span></label>
    <input type="text" name="ly_video_url" class="learny-form-control" id="ly_video_url" aria-describedby="ly_video_url" placeholder="<?php esc_html_e('.mp4 Video URL', BaseController::$text_domain); ?>" value="<?php echo esc_url_raw($ly_video_url); ?>">
</div>
